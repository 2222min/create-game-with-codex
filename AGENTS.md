...
- game-crossfunctional-sync: PO/개발/디자인이 주기적으로 충돌을 해소하고 결정을 고정하도록 협업 루프를 운영한다. (file: /Users/finda0603/Desktop/create-game-with-codex/skills/game-crossfunctional-sync/SKILL.md)
...
- Multi-skill sequencing: 신작 시작 시 기본 순서는 `game-studio-factory -> game-product-planner -> game-crossfunctional-sync -> game-market-skeptic -> game-architect-lead -> game-implementer-elite -> game-critical-reviewer -> game-asset-designer` 이다.
