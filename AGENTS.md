...
- Multi-skill sequencing: 기본 순서는 `game-product-planner -> game-market-skeptic -> game-architect-lead -> game-implementer-elite -> game-critical-reviewer -> game-asset-designer` 이다.
